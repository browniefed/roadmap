...
var RoadmapStore = Fluxxor.createStore({
    ...
    initialize: function() {
        this.bindActions(
            ...
            RoadmapConstants.ROADMAP_LOAD_ITEM_COMMENTS_COMPLETE, this.loadItemCommentsComplete
        )
    },

    loadItemCommentsComplete: function(payload) {
        this.selectedItemComments = payload;
        this.emit('change');
    },
    ...
    getState: function(roadmapId) {
        return {
            roadmap: Proxy.getRoadmap(roadmapId),
            selectedItemComments: this.selectedItemComments || []
        }
    },
